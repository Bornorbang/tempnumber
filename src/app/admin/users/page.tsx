...
type User = {
  ...
  wallet_balance: number; is_admin: boolean; created_at: string;
};
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-2xl overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="divide-y divide-[var(--border-color)]">
            {users.map((u) => (
              <div key={u.id} className="px-5 py-3.5 flex flex-col sm:grid sm:grid-cols-[1fr_1fr_auto_auto_auto] gap-2 sm:gap-4 sm:items-center">
                <div>
                  <p className="text-[var(--text-primary)] text-sm font-medium">{u.name}</p>
                ...
                <div className="flex justify-center">
                  {u.is_admin ? (
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full bg-[var(--bg-card-inner)] text-gray-500">User</span>
                  )}
                </div>
